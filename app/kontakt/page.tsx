...
export const metadata = {
  ...
  description:
    "Kontaktujte nás pro nezávaznou konzultaci ohledně vašeho webového projektu",
};
            ...
            <div className="lg:col-span-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Čím více informací nám poskytnete, tím lépe vám budeme moci
                    pomoci
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-6 space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Odpovídám na všechny poptávky do 24 hodin. Pro urgentní
                    záležitosti nás kontaktujte přímo emailem.
                  </p>
                </CardContent>
              </Card>
