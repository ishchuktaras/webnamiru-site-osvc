      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-white text-xl font-bold mb-4">webnamiru.site</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="mailto:info@webnamiru.site" className="hover:text-[#3B82F6]">info@webnamiru.site</a></li>
              <li><a href="tel:+420777596216" className="hover:text-[#3B82F6]">+420 777 596 216</a></li>
