  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0 z-10">
      ...
      >
        ...
        >
          <span className="inline-flex items-center rounded-full border-2 border-accent/30 bg-accent/20 px-4 py-1.5 text-sm font-medium text-accent backdrop-blur-md shadow-lg">
            <Rocket className="mr-2 h-4 w-4" />
            Strategický přístup k webovému vývoji
          </span>
        </motion.div>

        <h1 className="text-4xl md:text-6xl lg:text-8xl font-extrabold text-balance leading-tight [text-shadow:_0_2px_10px_rgb(0_0_0_/_20%)]">
          <motion.span
        ...
        <motion.div
          ...
          className="inline-block rounded-2xl bg-background/60 backdrop-blur-md px-6 py-4 border border-border/50 shadow-xl"
        >
          <p className="text-base lg:text-xl text-foreground max-w-2xl text-pretty leading-relaxed font-medium">
            Vytvářím webové stránky na míru, které nejen skvěle vypadají, ale především pomáhají vašemu podnikání růst.
            Od strategie přes design až po měřitelné výsledky.
          </p>
        </motion.div>
        ...
        >
          <Button
            size="lg"
            asChild
            className="bg-accent hover:bg-accent/90 shadow-2xl hover:shadow-accent/50 group transition-all duration-300"
          >
            <Link href="/kontakt">
              Začít projekt
          ...
          <Button
            ...
            variant="outline"
            asChild
            className="border-2 border-primary text-primary hover:bg-primary/10 bg-background/80 backdrop-blur-md shadow-xl"
          >
